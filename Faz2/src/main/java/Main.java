...
//                        xEpsilon - enemy.getXVertex(i) + 20,
//                        yEpsilon - enemy.getYVertex(i) + 20);
...
//                Rectangle square1 = new Rectangle(x1 - SQUARANTINE_SIZE / 2, y1 - SQUARANTINE_SIZE / 2,
//                        SQUARANTINE_SIZE, SQUARANTINE_SIZE);
//                Rectangle square2 = new Rectangle(x2 - SQUARANTINE_SIZE / 2, y2 - SQUARANTINE_SIZE / 2,
//                        SQUARANTINE_SIZE, SQUARANTINE_SIZE);
...
//                    squarantine.getX() - SQUARANTINE_SIZE / 2.0,
//                    squarantine.getY() - SQUARANTINE_SIZE / 2.0,
//                    SQUARANTINE_SIZE,
//                    epsilon.getX(),
//                    epsilon.getY(),
//                    EPSILON_SIZE);
...
//            int x1 = trigorath.getXVertex(0);
//            int y1 = trigorath.getYVertex(0);
//            int x2 = trigorath.getXVertex(1);
//            int y2 = trigorath.getYVertex(1);
//            int x3 = trigorath.getXVertex(2);
//            int y3 = trigorath.getYVertex(2);
...
//                        new Collectible(
//                                squarantine.getX(),
//                                squarantine.getY(), squarantine.getValue());
//                    }
//                }
//            }
//        }
...
//                        new Collectible(
//                                trigorath.getX() - 7,
//                                trigorath.getY(), trigorath.getValue());
//                        new Collectible(
//                                trigorath.getX() + 7,
//                                trigorath.getY(), trigorath.getValue());
//                    }
