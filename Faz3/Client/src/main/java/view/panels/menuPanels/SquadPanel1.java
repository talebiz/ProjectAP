...
public class SquadPanel1 extends SquadPanel {
    private static SquadPanel1 squadPanel1;

    private SquadPanel1() {
        super();
    }

    public static SquadPanel1 getInstance() {
        if (squadPanel1 == null) squadPanel1 = new SquadPanel1();
        return squadPanel1;
    }
